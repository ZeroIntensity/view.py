...
from ._logging import (VIEW_TEXT, Internal, Service, UvicornHijack,
                       enter_server, exit_server, format_warnings)
...
from .exceptions import (BadEnvironmentError, ConfigurationError, ViewError,
                         ViewInternalError)
from .install import check_dep, ensure_dep
...
class App(ViewApp):
    ...
    def __init__(self, config: Config) -> None:
        """
        Args:
            config: Configuration object to be used.
        """
        supply_parsers(self)
        self.config = config
