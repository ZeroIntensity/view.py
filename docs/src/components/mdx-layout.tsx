        ...
        <>
            ...
            >
                <div className="flex w-full justify-between py-16 px-4 md:px-0">
                    <nav className="lg:w-1/4 hidden lg:flex pl-12 z-10 flex-col space-y-8 sticky top-0 self-start pt-12">
                    ...
                    <div className="lg:px-0 px-4 w-full lg:w-1/2 flex flex-col space-y-3 break-words min-w-fit md:min-w-0">
                    ...
                    <div className="lg:w-1/4 hidden lg:block px-4 self-start top-0 sticky pt-12">
                            ...
                            <div className="grid grid-cols-1 auto-rows-fr gap-1 w-fit">
                                ...
                                >
                                    <span className="absolute inset-0 overflow-hidden rounded-lg">
                                        <span className="absolute inset-0 rounded-lg bg-[image:radial-gradient(75%_100%_at_50%_0%,rgba(56,189,248,0.6)_0%,rgba(56,189,248,0)_75%)] opacity-0 transition-opacity duration-150 group-hover:opacity-100" />
                                    </span>
                                    ...
                                    <span className="absolute -bottom-0 left-[1.125rem] h-px w-[calc(100%-2.25rem)] bg-gradient-to-r from-emerald-400/0 via-emerald-400/90 to-emerald-400/0 transition-opacity duration-150 group-hover:opacity-40" />
                                </a>
                                <a
